...
- The **_i_^th^ residual** is defined to be the perpendicular distance from the _i_^th^ datapoint to the line:
...
- I.e. the equation of the line in blue is  `r fit1$coefficients[1]` + `r fit1$coefficients[2]` * `x`.
...
$$ \begin{array}{cc}
  ...
  \displaystyle \sum_{i=1}^{n} y_i  = 14,\!3995.8;   & \displaystyle \sum_{i=1}^{n} (x_i - \overline{x})^2 =  87.23984   \\
