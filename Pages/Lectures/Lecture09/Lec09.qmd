...
- Surveying *every* *single* US Citizen and recording their income is not feasible
...
- We can see that the second quantity above [is a random variable!]{.underline}.
...
a. Identify the population : the population is the set of all cats in the world, since we the veterinarian seeks to describe the prevalence of FIV among *all cats*.

b. Identify the sample.: In this context, the sample is the set of 100 cats the veterinarian examined.

c. Identify the population parameter of interest: The population parameter of interest is $p =$ "the true proportion of cats that suffer from FIV".

d. Is the value of $3.2\%$ a population parameter, or an observed instance of a sample statistic?: The value of 3.2\% is an observed instance of a **sample statistic**, because if the veterinarian had taken a *different* sample of 100 cats she likely would have observed a different proportion of FIV-positive cats.
...
- When we make inferences we are trying to **estimate** the value of a population parameter.
...
## Sampling Distribution Demo (Interactive with OJS)

<iframe src="clt_demo.html" width="100%" height="800px" frameborder="0"></iframe>
