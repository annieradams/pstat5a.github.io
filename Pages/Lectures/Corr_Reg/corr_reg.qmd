...
a. 
\begin{align*}
  \widehat{\beta_0}   & = \frac{\sum_{i=1}^{n}(x_i - \overline{x})(y_i - \overline{y})} {\sum_{i=1}^{n} (x_i - \overline{x})^2} = \frac{379.945}{10,\!211.7} \approx \boxed{0.0372}   \\
  \widehat{\beta_0}   & = \overline{y} - \widehat{\beta_1} \cdot \overline{x} = \boxed{1436.159}
\end{align*}
Therefore,
$$ \widehat{(\texttt{amt. of soda})} = 1436.159 + (0.0372) \cdot (\texttt{flight duration}) $$

\

b. $\widehat{y}^{(110)} = 1436.159 + (0.0372)(110) = \boxed{1440.251 \text{ oz.}}$
