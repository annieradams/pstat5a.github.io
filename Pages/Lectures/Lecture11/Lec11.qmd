...
meaning the constant $z^*$ should be selected as the appropriate percentile of the *standard normal* distribution:
...
Part e. Construct a 90\% confidence interval for the true average temperature across all weather stations in Antarctica.

$$ \overline{x} \pm z^{\ast} \cdot \frac{\sigma}{\sqrt{n}} $$

With a 90% confidence interval, we know $z^*$ = 1.645. Therefore, 

$$ 26 \pm 1.645 * \frac{8}{\sqrt{81}} $$
...
- The $t-$distribution looks very similar to the standard normal distribution in that it is centered at 0, and has a bell-like density curve.
