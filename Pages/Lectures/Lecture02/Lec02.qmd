...
- Identifying trends is not the same thing as identifying **causal relationships**.
...
Given the set X = {1, 4, 9, 16, 25, 36}, find the summation of the square root of each element in X.


## Practice Problem #2

A basketball coach recorded the points scored by her starting five players in their last game and recorded them below:

**Data:** {12, 8, 15, 10, 20}

Calculate the standard deviation of points scored by these players. Interpret what the answer you get means in terms of points. 
