...
Your conclusion should include: 
  ...
  1. significance level, [At an $\alpha$ = .05 level of significance]{.fragment style="color: blue;"} 
  2) decision of the test, , [There was sufficient evidence to reject the Census' claim]{.fragment style="color: blue;"}
  3) as a function of the null hypothesis. Then we write an interpretation that is, [that the average commute time of Americans was 27.6 minutes]{.fragment style="color: blue;"}
  4) in affirmation or not in affirmation of the alternative hypothesis., [in favor of the alternative that the true average commute time was not 27.6 minutes.]{.fragment style="color: blue;"} 
...
- This means our critical value is 2.0; since $|\mathrm{TS}| = |2.10| = 2.10 > 2$, we would again reject at an $\alpha = 0.05$ level of significance.
...
## Lower-tailed difference in mean tests {style="font-size:32px"}
:::{.fragment}
- Unsurprisingly, we can adapt the above procedure to account for one-sided alternatives as well.Our lower tailed test would look like: 
:::
...
## Upper-tailed difference in mean tests {style="font-size:32px"}
