...
- What proportion of penguins had flippers between 190 and 210 mm long? (Remember there EW 344 penguins included in the dataset) 
:::
...
## **Definition**
::: {style="font-size: 30px"}
The **_p_^th^ percentile** of a set of observations $X$ is the value $\pi_{x, \ 0.5}$ such that _p_% of observations lie to the left of (i.e. are less than) $\pi_{x, \ 0.5}$.
:::
:::
:::
