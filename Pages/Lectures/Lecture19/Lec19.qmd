...
## Class Announcements
- Exam this Thursday! Make sure to bring calculator, pencils, and access card! 
- Extra credit homework due **Wednesday** 
- Course evals! 
...
- One way to remedy this would be to perform what is known as stratified sampling in which we first divide the population into several *strata* (i.e. groups), and then take an SRS from each stratum.
...
## Stratified sampling {style="font-size:30px"}
...
## Cluster sampling {style="font-size:30px"}
...
- **Experimental Design** loosely refers to the principles of and procedures related to setting up an experiment.git 
