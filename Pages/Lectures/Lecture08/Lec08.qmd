...
## Class Updates 
- Reminder: Quiz 2 today, due at 11:50 pm! 
- Week 1 grades posted 
- No more mandatory homework 6, extra credit hw instead! 
- Homework 3 posted and due Thursday 
...
- The quantity $\mathbb{P}(X \leq x)$, where we view $x$ as an arbitrary input is called the **cumulative distribution function** (or **c.d.f.** for short) of $X$.
